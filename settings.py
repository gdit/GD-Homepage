...
ADMINS = (
    ( 'IT Officer', 'it.guarddogs@gmail.com' ),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'mem.db'),                      # Or path to database file if using sqlite3.
...
STATIC_URL = 'http://empathos.dyndns.org/static/'
...
# Additional locatioans of static files
STATICFILES_DIRS = (
...
SECRET_KEY = '$yp4wk(=pma^*mu_-n$c4d0u#7xflq033cs2q)^6e6lq4*dlo^'
